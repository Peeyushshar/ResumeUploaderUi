import { Grid, TextField, Typography, FormControlLabel, Checkbox, 
Button, Box, Alert, InputLabel, MenuItem, Select, FormControl,
FormLabel, RadioGroup, Radio, FormGroup, Stack, Table, TableBody,
TableCell, TableContainer, TableHead, TableRow, Paper, Avatar, Input} from '@mui/material';
   ...
   <Grid container justifyContent='center'>
    ...
    <Grid item xs ={5}>
      <Box component="form" sx={{ p: 3}} noValidate id='resume-form' onSubmit={handleSubmit}>
        ...
        <Box mt={1}>
          {/* <LocalizationProvider dateAdapter={ AdapterDateFns }>  */}
             {/* <DatePicker label="Date of Birth" value={dob} onChange={ (newDob) => setDob(newDob)}
      ...
      <DemoContainer components={['DatePicker']}>
        <DatePicker label="Date of Birth" value={dob} onChange={ handleChange } />
      </DemoContainer>
    </LocalizationProvider>
          </Box>
